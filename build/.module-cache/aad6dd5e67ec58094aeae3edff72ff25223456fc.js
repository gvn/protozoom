...
var Slot = React.createClass({displayName: "Slot",
  render: function () {
    return (
      React.createElement("div", {className: "slot", style: "width: { (100 / this.props.perRow) + '%' }"}, 
        this.props.children
      )
    );
  }
    ...
    for (var y = 0; y < this.props.layout.length; y++) {
      for (var x = 0; x < this.props.layout[0].length; x++) {
        if (this.props.layout[x][y]) {
          nodes.push(
            React.createElement(Slot, {x: x, y: y}, 
              React.createElement(Tile, null)
            )
          );
        } else {
          nodes.push(React.createElement(Slot, {x: x, y: y}));
        }
      }
    }
      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "wrapper"}, 
          React.createElement(Draggable, {zIndex: 100}, 
            React.createElement("div", null, 
              React.createElement(Grid, {layout:  generateLayout(10,10) })
            )
          )
        )
      )
