...
var App = React.createClass({displayName: "App",
  ...
  changeZoom: function (event) {
    ...
    window.MG = this.refs.masterGrid;
    this.setState({
      appZoom: this.state.appZoom + 1
    });
  },
  render: function () {
      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "wrapper"}, 
          React.createElement(Draggable, {zIndex: 100}, 
            React.createElement("div", null, 
              React.createElement(Grid, {zoomProp:  this.state.appZoom, ref: "masterGrid", layout:  generateLayout(width, height) })
            )
          )
        )
      )
